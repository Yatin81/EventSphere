...
router.post("/", authMiddleware, requireRole("ADMIN"), controller.createEvent.bind(controller));
router.delete("/:id", authMiddleware, requireRole("ADMIN"), controller.deleteEvent.bind(controller));
