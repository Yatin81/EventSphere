...
router.post("/", authMiddleware, requireRole("ADMIN"), controller.createSeats.bind(controller));
...
router.post("/lock", authMiddleware, controller.lockSeats.bind(controller));
